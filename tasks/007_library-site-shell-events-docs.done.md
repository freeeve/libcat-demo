...
Demonstrate that libcatalog is *one section* of an ordinary Hugo-built library website,
...
1. **Homepage = library landing** (not the catalog). Hero/welcome, hours + visit info,
   ...
   "built with libcatalog + Hugo" explainer. Catalog stays at `/works/`.
...
4. **Docs / "How this is built"** (`content/docs/`): how Hugo works + how libcatalog ties
